...
inline static const uint16_t total_range_buckets = 0x400;

// inline static const uint16_t total_range_buckets = 1024;
inline static const uint16_t total_hash_partitions = 0x400;  // 16384
