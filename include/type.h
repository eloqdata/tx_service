...
struct TableName
{
    ...
    {
        return engine_ == TableEngine::EloqKv || engine_ == TableEngine::None || engine_ == TableEngine::InternalHash || engine_ == TableEngine::Sequence;
    }
...
constexpr static std::string_view internal_range_table_name_sv{"__internal_range_table"};
constexpr static std::string_view internal_hash_table_name_sv{"__internal_hash_table"};
...
inline static TableName internal_range_table_name{
    internal_range_table_name_sv, TableType::Primary, TableEngine::InternalRange};
