...
Per batch, `DataMigrationOp` (`tx_operation.h:1395`) stages — each log write carries a `BucketMigrateStage` (`log_service/tx-log-protos/log.proto:135`):
